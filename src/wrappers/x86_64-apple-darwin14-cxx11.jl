# Autogenerated wrapper script for SymEngine_jll for x86_64-apple-darwin14-cxx11
export libsymengine
...
const libsymengine_splitpath = ["lib", "libsymengine.0.5.0.dylib"]
...
const libsymengine = "@rpath/libsymengine.0.5.dylib"
