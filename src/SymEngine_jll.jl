...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SymEngine_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3428059b-622b-5399-b16f-d347a77089a4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SymEngine", artifacts_toml) for e in artifacts["SymEngine"]]
...
if best_platform === nothing
    @debug("Unable to load SymEngine; unsupported platform $(triplet(platform_key_abi()))")
else
